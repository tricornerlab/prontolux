...
@section('content')
    ...
    <div class="bg-white overflow-hidden shadow rounded-lg min-h-full">
        ...
        @foreach($trend as $post)
            ...
            <h3 class=" h-20 pt-8 mx-8 font-bold"><a href="{{Route('trends.index')}}">Nos projects</a><span class="text-[#94ae0e]"> > </span> {{$post['name']}}</h3>
            ...
            <div class="border-b pb-8">
                ...
                <div class="grid grid-rows-1 mt-4 ml-4 pb-4">
                    @foreach($files as $url)
                        <div class="w-full"><img class="m-4 shadow-xl rounded" src={{asset("storage/$url")}}></div>
                    @endforeach
                </div>
