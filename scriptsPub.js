...
function showCat(c,pc,l,n){
    ...
    /*
    if(l==0){
        var sels = document.getElementsByClassName('catLinkSel');
    ...
    */
    ...
    if(l==0){
		...
		var sels = document.getElementsByClassName('catLinkImgSel');
        for(t = 0; t < sels.length; t++) {
            var elId = sels[t].id;
            document.getElementById(elId).setAttribute('class','catLink');
        }
...
function popitup(url) {
	newwindow=window.open(url,'ProductDetail','height=850,width=1020');
